<div class="col-lg-9 col-md-12 col-sm-12 col-pad">
    <div class="content-area5">
        ...
        <tr>
            ...
            <td scope="col"><?= $booking->alamat;?>,<?= $booking->kecamatan;?>,<?= $booking->kabupatenKota;?>,<?= $booking->provinsi;?></td>
            <td scope="col">Rp. <?= $booking->hargaBulanan;?>/Bulan</td>
            <td scope="col"><a class="btn btn-warning"><?php if($booking->status == '0'){echo 'Belum Dibayar' ;}elseif($booking->status == '1'){echo 'Sudah Dibayar' ;} ?></a>
            </td>
            <td scope="col"><a href="" class="btn btn-xs btn-success">Bayar</a><a href="<?= base_url('user/delete/'.$booking->idBooking)?>" class="btn btn-xs btn-danger">Hapus</a></td>
